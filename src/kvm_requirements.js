...
import { sendStatus, sendError, sendOutput, commandToCheck, runMultiCommand, installNeeded, getCommandOutput, saveToStore, getPlatform } from './helpers';
...
function Requirements(props) {
  ...
  const netCheck = (net) => {
    saveToStore('kvm.KVM_NETWORK', JSON.stringify(net));
    setNetwork(net);
  }
